...
jobject EnnBufferPtrAndNumberOfBuffersInfoToBufferSetInfo(
    ...
    jclass bufferSetInfo = env->FindClass("com/samsung/helpcrossing/enn_type/BufferSetInfo");
...
Java_com_samsung_helpcrossing_executor_ModelExecutor_ennInitialize(
        JNIEnv *env,
        jobject thiz
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_samsung_helpcrossing_executor_ModelExecutor_ennDeinitialize(
        JNIEnv *env,
        jobject thiz
) {
...
Java_com_samsung_helpcrossing_executor_ModelExecutor_ennOpenModel(
        JNIEnv *env,
        jobject thiz,
        jstring j_filename
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_samsung_helpcrossing_executor_ModelExecutor_ennCloseModel(
        JNIEnv *env,
        jobject thiz,
        jlong model_id
) {
...
Java_com_samsung_helpcrossing_executor_ModelExecutor_ennAllocateAllBuffers(
        JNIEnv *env,
        jobject thiz,
        jlong model_id
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_samsung_helpcrossing_executor_ModelExecutor_ennReleaseBuffers(
        JNIEnv *env,
        jobject thiz,
        jlong j_buffers_set,
        jint buffer_size
...
extern "C"
JNIEXPORT void JNICALL
Java_com_samsung_helpcrossing_executor_ModelExecutor_ennExecute(
        JNIEnv *env,
        jobject thiz,
        jlong model_id
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_samsung_helpcrossing_executor_ModelExecutor_ennMemcpyHostToDevice(
        JNIEnv *env,
        jobject thiz,
        jlong j_buffer_set,
        jint layer_number,
...
Java_com_samsung_helpcrossing_executor_ModelExecutor_ennMemcpyDeviceToHost(
        JNIEnv *env,
        jobject thiz,
        jlong j_buffer_set,
        jint layer_number
